          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-6">
                Started as a curious student learning HTML and CSS, I've evolved
                into a full-stack developer who loves solving complex problems
                and creating intuitive user experiences. I believe in writing
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="max-w-[400px]" isPressable>
